...
class ExampleLogger(MetricsLogger):
    def _collect_metrics(self, game_state: GameState) -> np.ndarray:
        return np.array([game_state.players[0].car_data.linear_velocity,
...
def build_rocketsim_env():
    ...
    obs_builder = DefaultObs(
        pos_coef=np.asarray([1 / common_values.SIDE_WALL_X, 1 / common_values.BACK_NET_Y, 1 / common_values.CEILING_Z]), # pyright: ignore[reportArgumentType]
        ang_coef=1 / np.pi,
